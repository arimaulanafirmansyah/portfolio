		...
		<div class="main">
			...
			<div class="details">
				<div class="recentText">
					...
					<table>
                <a href="/api/game/ml?apikey=APIKEY&id=89867767_2181"><li>Mobile Legends</li></a>
                <a href="/api/game/ff?apikey=APIKEY&id=470742510"><li>Free Fire</li></a>
                <a href="/api/game/hdi?apikey=APIKEY&id=79678285"><li>Higgs Domino</li></a>
                <a href="/api/game/pb?apikey=APIKEY&user=amfstore13"><li>Point Blank</li></a>
					</table>
				</div>
			</div>
