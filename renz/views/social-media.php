	...
	<div class="container">
		<div class="navigation">
			<ul>
				...
				<li>
					<hr>
					<a href="amfcode-api.herokuapp.com/index.php">
		...
		<div class="main">
			...
			<div class="details">
				<div class="recentText">
					...
					<table>
                <a href="/api/stalk/ig?apikey=APIKEY&username=amfcode_"><li>Instagram Stalker</li></a>
                <a href="/api/stalk/tiktok?apikey=APIKEY&username=chikakiku"><li>Tiktok Stalker</li></a>
                <a href="/api/stalk/npm?apikey=APIKEY&query=zhirrr-api&hostname=zhirr"><li>Info NPM</li></a>
					</table>
				</div>
			</div>
